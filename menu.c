...
// main menu
const char ST_WELCOME_TXT[]				PROGMEM = "BH OVEN < ";
const char ST_TEMP_PTS_TXT[]			PROGMEM = "T' POINTS >";
	const char ST_TEMP_SETPALIER_TXT[]		PROGMEM = "PALLIER <>";
	const char ST_TEMP_SETPIC_TXT[]			PROGMEM = "PIC <";
const char ST_PROFILES_TXT[]			PROGMEM = "PROFIL >";
...
//  STATE                       TEXT						FUNCTION
	...
	{ST_TEMP_PTS_ID,			ST_TEMP_PTS_TXT,			NULL},
		{ST_TEMP_SETPALIER_ID,		ST_TEMP_SETPALIER_TXT,		st_temp_palier},
		{ST_TEMP_SETPIC_ID,			ST_TEMP_SETPIC_TXT,			st_temp_pic},		
	{ST_PROFILES_ID,			ST_PROFILES_TXT,			NULL},
	...
	{ST_MANUAL_TEMP_ID,			ST_MANUAL_TEMP_TXT,			NULL},
		{ST_MANUAL_SET_TEMP_ID,		ST_MANUAL_SET_TEMP_TXT,		NULL},
	{ST_MANUAL_CMD_ID,			ST_MANUAL_CMD_TXT,			NULL},
...
//  STATE                       INPUT						NEXT STATE
	...
	{ST_TEMP_PTS_ID,			KEY_RIGHT,					ST_TEMP_SETPALIER_ID},
		{ST_TEMP_SETPALIER_ID,		KEY_NULL,					ST_TEMP_SETPALIER_ID},
		{ST_TEMP_SETPALIER_ID,		KEY_LEFT,					ST_TEMP_PTS_ID},
		{ST_TEMP_SETPALIER_ID,		KEY_RIGHT,					ST_TEMP_SETPIC_ID},
			{ST_TEMP_SETPIC_ID,			KEY_NULL,					ST_TEMP_SETPIC_ID},
			{ST_TEMP_SETPIC_ID,			KEY_LEFT,					ST_TEMP_SETPALIER_ID},
	...
	{ST_MANUAL_TEMP_ID,			KEY_RIGHT,					ST_MANUAL_SET_TEMP_ID},
		{ST_MANUAL_SET_TEMP_ID,		KEY_NULL,					ST_MANUAL_SET_TEMP_ID},
		{ST_MANUAL_SET_TEMP_ID,		KEY_LEFT,					ST_MANUAL_TEMP_ID},						
